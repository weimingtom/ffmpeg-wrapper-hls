...
static void print_report(int is_last_report, int64_t timer_start, int64_t cur_time)
{
    ...
    double bitrate;
    int64_t pts = INT64_MIN, duration_5 = INT64_MIN;
    ...
    for (i = 0; i < nb_output_streams; i++) {
        ...
        
        {
			...
			{
				//fprintf(stderr, "duration_5===>%"PRId64">>\n", input_files[ist->file_index]->ctx->duration);
				duration_5 = input_files[ist->file_index]->ctx->duration;
			}
        }
    }
    ...
    fprintf(stderr, "pts===>%"PRId64", duration_5===>%"PRId64">>\n", pts, duration_5);
...
static int transcode_init(void)
{
	...
	//fprintf(stderr, "duration_3===>%"PRId64">>\n", ist->st->duration);
...
static int transcode_step(void)
{
    ...
    //fprintf(stderr, "duration_4===>%"PRId64">>\n", input_files[ist->file_index]->ctx->duration);
